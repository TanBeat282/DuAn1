...
public class DangMuaAdapter extends BaseAdapter {
    ...
    public DangMuaAdapter(Context context, ArrayList<DangMua> list, String idNguoiDung) {
    ...
    public View getView(int _i, View _view, ViewGroup _viewgroup) {
        ...
        holder.linearChiTiet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("result", "dangmua");
